...
main/vehicle_*, main/ble_client.*, main/logic/{command_registry,command_runner,ble_dispatcher,rx_framing,session_state,command_result,key_rotation,ble_chunk,ble_deferred_event}.hpp,
