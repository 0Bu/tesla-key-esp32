...
| Browser-origin decision for mutating POSTs (same Host/Origin including default ports, cross-site/null/malformed rejection, headerless evcc/curl compatibility) | `logic/http_origin.hpp` | `http_server.cpp` wildcard dispatcher |
