...
| One-shot charge poll on self-wake edge and cache-invalid bootstrap (debounced ASLEEP arming, cache-invalid bootstrap, queue-idle/connected gate with pending latch retention) | `logic/wake_poll.hpp` | `vehicle_telemetry.cpp` (`loop_task_fn_`) |
