...
// tree builds esp32 / esp32s3 / esp32c3 / esp32c6; this maps the running chip to the
// strings the rest of the system depends on:
...
enum class Target { Esp32, Esp32S3, Esp32C3, Esp32C6 };
